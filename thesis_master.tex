...
\documentclass[
	...
	screen,   % makes the thesis better readable on screens (onesided, coloured links)
  	...
  	bibNumeric,         % citation style (IfA standard), alternatives: bibNumeric, bibHarvard, bibIfa
...
\ifaThesis{Bachelorarbeit}  % type of the thesis                
...
\ifaAuthorCourse{Luft- und Raumfahrt}  % study program
...
\ifaDayOfSubmission{27.04.2018}  % the day the thesis is submitted
\ifaTopicDescriptionPDF{content/Aufgabenstellung.pdf}  % a PDF file of the topic description
\ifaAppendix{content/appendix}  % a tex file containing the appendix for the thesis

% Literaturverzeichnis angeben
\bibliography{bibliography}  % a file containing the reference sources
